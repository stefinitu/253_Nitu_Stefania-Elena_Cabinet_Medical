...
public class Asistent extends Personal {
    ...
    public Asistent(double cnp, String nume, String prenume, String sectie, int zi_angajare, int luna_angajare, int an_angajare, double salariu, String nr_telefon, String email, int nr_saloane_atribuite) {
    ...
    public void CitirePersonal() {
        ...
        this.nr_saloane_atribuite=scanner.nextInt();
    }
    @Override

...
public class GUIOp21 {
    public void GUI() {
        ...
        try {
            ...
            String sqlInsertPrMin = "INSERT INTO programare_clientminor (ID_PROGRAMARE, COD_BILET, CNP, ZI_PROGRAMARE, LUNA_PROGRAMARE, AN_PROGRAMARE, ZI_PLANIFICARE, LUNA_PLANIFICARE, AN_PLANIFICARE, SECTIE) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            String cnpClientminor=JOptionPane.showInputDialog("CNP CLIENT minor");

...
public class BDProgramareMaj {
    public void PrMajSelect() {
        ...
        try {
            ...
            System.out.println(programariMaj);
            conn.close();
    ...
    public void ProgMajInsert() {
        ...
        try {
            ...
            Programare prog=new Programare(0,0,clMaj,0,0,0,0,0,0," ");
            System.out.println("Citire programare pentru client major noua:");
            prog.CitireProg();
